...
- Home-screen icon uses the new ExampleApp monogram, not the older `L` icon.
- Add-to-home-screen flow succeeds on iPhone.
- Installed PWA opens with the expected name `ExampleApp`.
