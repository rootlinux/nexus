...
async def create_admin_post_removed_notification(
    db: AsyncSession,
    *,
    recipient_user_id: int,
    actor_user_id: int,
    ...
    return await create_notification(
        ...
        actor_user_id=actor_user_id,
        notification_type=NotificationType.ADMIN_POST_REMOVED,
        post_id=post_id,
...
async def create_account_suspended_notification(
    db: AsyncSession,
    *,
    recipient_user_id: int,
    actor_user_id: int,
...
async def create_account_banned_notification(
    db: AsyncSession,
    *,
    recipient_user_id: int,
    actor_user_id: int,
...
async def create_account_frozen_notification(
    db: AsyncSession,
    *,
    recipient_user_id: int,
    actor_user_id: int,
    ...
    return await create_notification(
        ...
        recipient_user_id=recipient_user_id,
        actor_user_id=actor_user_id,
        notification_type=NotificationType.ACCOUNT_FROZEN,
    )
