# Güvenlik Denetim Raporu — example.com
**Tarih:** 13 Nisan 2026  
**Kapsam:** https://example.com, https://api.example.com, https://app.example.com  
...
| Kapsam | `*.example.com`, `example.com` |
...
### api.example.com CORS Davranışı
...
| Subdomain | IP | Durum |
|---|---|---|
| `example.com` | CF: `104.21.79.142` | AKTİF |
| `www.example.com` | CF: `172.67.146.15` | AKTİF |
| `app.example.com` | CF: `104.21.79.142` | AKTİF |
| `api.example.com` | CF: `172.67.146.15` | AKTİF |
...
#### B-1: `x-request-id` Header (api.example.com)
...
#### B-3: `app.example.com` Subdomaini
`app.example.com` de aynı uygulamayı sunuyor (`www.example.com` ve `example.com` ile aynı). Eğer kullanılmıyorsa DNS kaydını kaldır, kullanılıyorsa canonical URL'yi standartlaştır.
