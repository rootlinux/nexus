...
- [ ] `docs/`, `README`, `examples/` içinde eski ExampleApp referansları temizlenmeli
...
| Servis | Domain |
|--------|--------|
| Web (Next.js) | example.com |
| API (FastAPI) | api.example.com |
...
```markdown
# 003 — Nexus Rebrand (eski adı: ExampleApp)

**Tarih:** 2026-04-29  
**Durum:** kısmen tamamlandı

## Bağlam
Platform ExampleApp adıyla başladı. Nexus olarak rebranding yapıldı.
