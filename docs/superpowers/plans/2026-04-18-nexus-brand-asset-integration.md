...
**Goal:** Import the final Nexus PNG branding assets from Downloads, generate the required web icon derivatives, and update the frontend to serve the new logo pack everywhere old ExampleApp assets were referenced.
...
- [ ] **Step 4: Replace remaining old ExampleApp logo asset references**
...
- [ ] **Step 2: Search for stale ExampleApp references again**
