...
class DiscoverUserEntry(BaseModel):
    """A single user suggestion entry returned by GET /api/discover/users."""
    id: int
    username: str
...
class DiscoverUsersResponse(BaseModel):
    """Paginated response for GET /api/discover/users."""
    users: List[DiscoverUserEntry]
    total: int
    limit: int
    offset: int
    has_more: bool
